    ...
    try {
      ...
      if (isEditMode && property?.id) {
        ...
        toast({
          ...
          description: "The property details have been saved to Firestore.",
        });
      } else {
        ...
        toast({
          ...
          description: "The new property has been added to Firestore.",
        });
      }
    } catch (error: any) {
      toast({
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="A beautiful and modern apartment..."
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
